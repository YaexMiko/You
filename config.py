...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002354376085"))
#your id of telegram can be found by https://t.me/MissRose_bot with '/id' command
OWNER_ID = int(os.environ.get("OWNER_ID", "6943832981"))
#port set to default 8080
PORT = os.environ.get("PORT", "6196")
#your database url mongodb only You can use mongo atlas free cloud database
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Cutie:aloksingh@cutie.k7ne6.mongodb.net/?retryWrites=true&w=majority")
#your database name
DB_NAME = os.environ.get("DB_NAME", "Cutie")
